var PlayScreen = (function () {
    ...
    PlayScreen.prototype.show = function (next) {
        ...
        var turnLeft = this.stage.drawFresh(Width.get(32, 4), Height.get(48, 44), 'left', undefined, undefined,
            undefined, undefined, 3);
        drawables.push(turnLeft);
        var turnRight = this.stage.drawFresh(Width.get(32, 28), Height.get(48, 44), 'right', undefined, undefined,
            undefined, undefined, 3);
        ...
        var cat1 = this.stage.drawFresh(Width.HALF, subtract(Height.HALF, outerCircle.getHeightHalf.bind(outerCircle)),
            'white_cat', 4);
        var cat2 = this.stage.drawFresh(Width.HALF, add(Height.HALF, outerCircle.getHeightHalf.bind(outerCircle)),
            'black_cat', 4);
